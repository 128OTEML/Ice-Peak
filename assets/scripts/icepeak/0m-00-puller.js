...
const blockType = extend(StorageBlock, "0m-00-puller", {
    load() {
        this.super$load();
        topRegion = lib.loadRegion("0m-00-puller-top");
        bottomRegion = lib.loadRegion("0m-00-puller-bottom");
        rotatorRegion = lib.loadRegion("0m-00-puller-rotator");
    },
    init() {
        this.super$init();
