...
const blockType = extend(StorageBlock, "0m-01-pusher", {
    load() {
        this.super$load();
        topRegion = lib.loadRegion("0m-01-pusher-top");
        bottomRegion = lib.loadRegion("0m-01-pusher-bottom");
        rotatorRegion = lib.loadRegion("0m-01-pusher-rotator");
    },
